...
class ConfigManager
{
  ...
  private:
    ...
    std::map<Cfg, std::pair<std::string, std::string>> m_Keys{
        ...
        {Cfg::FactorApply, {"compensation_factors", "apply"}},
        {Cfg::FactorTrackerRoll, {"compensation_factors", "tracker_roll"}},
        {Cfg::FactorTrackerPitch, {"compensation_factors", "tracker_pitch"}},
        {Cfg::FactorTrackerYaw, {"compensation_factors", "tracker_yaw"}},
        {Cfg::FactorTrackerSurge, {"compensation_factors", "tracker_surge"}},
        {Cfg::FactorTrackerSway, {"compensation_factors", "tracker_sway"}},
        {Cfg::FactorTrackerHeave, {"compensation_factors", "tracker_heave"}},
        {Cfg::FactorHmdRoll, {"compensation_factors", "hmd_roll"}},
        {Cfg::FactorHmdPitch, {"compensation_factors", "hmd_pitch"}},
        {Cfg::FactorHmdYaw, {"compensation_factors", "hmd_yaw"}},
        {Cfg::FactorHmdSurge, {"compensation_factors", "hmd_surge"}},
        {Cfg::FactorHmdSway, {"compensation_factors", "hmd_sway"}},
        {Cfg::FactorHmdHeave, {"compensation_factors", "hmd_heave"}},
